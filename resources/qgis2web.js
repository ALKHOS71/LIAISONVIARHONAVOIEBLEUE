...
map.getView().fit([544065.583277, 5778070.730526, 550778.359467, 5781931.788982], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LIAISON VIARHONA VOIE BLEUE</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_LIAISONAMENAGEMENTSPRECONISES_6,
    colName: 'AMENAGEMENTS PRECONISES',
    zoom: 10,
    collapsed: true,
    map: map
});
